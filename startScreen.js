function renderStartBlock(){
    ...
    diffButtons.addEventListener('click', (event) => {
        ...
        if (target.tagName === "BUTTON"){
            ...
            Array.from(diffButtons.children).forEach(child => child.classList.remove('start-screen__diff-changer_current'));
            ...
            [
                {
                    ...
                    [
                        {  
                            tag: 'button',
                            cls: ['start-screen__diff-changer', 'start-screen__diff-changer_current'],
                            content: '1',                       
                        },
                        {
                            tag: 'button',
